# Futhesia Moduora (MoDuKu) - フセシア・モデュオラ（モヅク）
...
## Overview | 概要
MoDuKu is an intellectually and structurally evolving input device that spontaneously emerged from information dust accumulated in the Hadop stratum.
...
![MoDuKu Keymap](keymap-drawer/MDK.svg)
